            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav_list">
                         ...
                         <a href="{{'reviews'}}" class="nav_link @if (\Request::is('team')) active  @endif""><i class="fa fa-renren" aria-hidden="true"></i><span class="nav_name">Review</span> </a>
                         <a href="#" class="nav_link"><i class="fa fa-rss" aria-hidden="true"></i><span class="nav_name">Blog</span> </a>
                         <a href="{{'services'}}" class="nav_link @if (\Request::is('team')) active  @endif""><i class="fa fa-server" aria-hidden="true"></i><span class="nav_name">Service</span> </a>
