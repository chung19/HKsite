...
<form action="{{ route('blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="date" style="display: none;" class="form-control" placeholder="Title" value="{{Carbon\Carbon::now()->toFormattedDateString()}}">
    <input type="text" name="author" style="display: none;"class="form-control" placeholder="Title" value="Admin">
</form>
@endsection