...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Istok+Web:wght@400;700&family=Montserrat:wght@300;400;500;600;700&display=swap"
      rel="stylesheet"
    />
    ...
    <link
      rel="stylesheet"
      href="./assets/fonts/fontawesome-free-6.0.0-web/css/all.min.css"
    />
                ...
                <div class="articles_list_content_left">
                  ...
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="text">
                      <div class="articles_list_text_title">
                        <a href="#">
                          <h3 class="h5">Benefits of App Developed</h3></a
                        >
                      </div>
                  ...
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="text">
                      <div class="articles_list_text_title">
                        <a href="#">
                          <h3 class="h5">UI/UX Design Services</h3></a
                        >
                      </div>
                      <div class="articles_list_text_date">
                        <div class="icon">
                  ...
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="text">
                      <div class="articles_list_text_title">
                        <a href="#">
                          <h3 class="h5">Higher Programming Consult</h3></a
                        >
                      </div>
                      <div class="articles_list_text_date">
                        <div class="icon">
                    ...
                    <div class="popular_posts_content">
                      <ul class="popular_posts_content_list">
                        <li class="popular_archives_content_item">
                          <img
                            src="./assets/image/icon-folder-open.png"
                            alt=""
                          />
                          <span>Sep 2020</span>
                        </li>
